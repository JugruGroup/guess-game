...
export class GuessTagCloudBySpeakerComponent implements OnInit, OnDestroy {
  ...
  public speakerTagClouds: SpeakerTagClouds;
  public title: string;
  ...
  loadQuestion() {
    this.stateService.getSpeakerTagClouds(this.language)
      .subscribe(data => {
          if (data) {
