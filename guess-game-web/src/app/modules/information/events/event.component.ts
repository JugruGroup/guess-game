...
export class EventComponent implements OnInit, OnDestroy {
  ...
  isEventLinksVisible() {
    return this.eventDetails.event?.siteLink || this.eventDetails.event?.facebookLink || this.eventDetails.event?.vkLink ||
      this.eventDetails.event?.twitterLink || this.eventDetails.event?.youtubeLink ||
      this.eventDetails.event?.telegramChatLink || this.eventDetails.event?.telegramChannelLink ||
