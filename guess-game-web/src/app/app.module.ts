...
const routes: Routes = [
  {path: 'home', component: HomeComponent},
  {
    ...
    children: [
      ...
      {path: 'guess/name-by-photo', component: GuessNameByPhotoComponent, canActivate: [gameStateCanActivate]},
      {path: 'guess/photo-by-name', component: GuessPhotoByNameComponent, canActivate: [gameStateCanActivate]},
      {path: 'guess/talk-by-speaker', component: GuessTalkBySpeakerComponent, canActivate: [gameStateCanActivate]},
      {path: 'guess/speaker-by-talk', component: GuessSpeakerByTalkComponent, canActivate: [gameStateCanActivate]},
      {path: 'guess/company-by-speaker', component: GuessCompanyBySpeakerComponent, canActivate: [gameStateCanActivate]},
      {path: 'guess/speaker-by-company', component: GuessSpeakerByCompanyComponent, canActivate: [gameStateCanActivate]},
      {path: 'guess/account-by-speaker', component: GuessAccountBySpeakerComponent, canActivate: [gameStateCanActivate]},
      {path: 'guess/speaker-by-account', component: GuessSpeakerByAccountComponent, canActivate: [gameStateCanActivate]},
      {path: 'guess/tag-cloud-by-speaker', component: GuessTagCloudBySpeakerComponent, canActivate: [gameStateCanActivate]},
      {path: 'guess/speaker-by-tag-cloud', component: GuessSpeakerByTagCloudComponent, canActivate: [gameStateCanActivate]},
  ...
  },
  {
    ...
    children: [
      ...
      {path: 'event-types/search', component: EventTypesSearchComponent},
      {path: 'event-types/event-type/:id', component: EventTypeComponent},
      {path: 'events/search', component: EventsSearchComponent},
      {path: 'events/event/:id', component: EventComponent},
      {path: 'talks/search', component: TalksSearchComponent},
      {path: 'talks/talk/:id', component: TalkComponent},
      {path: 'speakers/list', component: SpeakersListComponent},
      {path: 'speakers/search', component: SpeakersSearchComponent},
      {path: 'speakers/speaker/:id', component: SpeakerComponent},
      {path: 'companies/list', component: CompaniesListComponent},
      {path: 'companies/search', component: CompaniesSearchComponent},
      {path: 'companies/company/:id', component: CompanyComponent},
      {path: 'statistics/event-types', component: EventTypeStatisticsComponent},
      {path: 'statistics/events', component: EventStatisticsComponent},
      {path: 'statistics/speakers', component: SpeakerStatisticsComponent},
      {path: 'statistics/companies', component: CompanyStatisticsComponent},
      {path: 'statistics/olap', component: OlapStatisticsComponent},

      {path: 'event-types', redirectTo: '/information/event-types/search'},
      {path: 'events', redirectTo: '/information/events/search'},
      {path: 'talks', redirectTo: '/information/talks/search'},
      {path: 'speakers', redirectTo: '/information/speakers/list'},
      {path: 'companies', redirectTo: '/information/companies/list'},
      {path: 'statistics', redirectTo: '/information/statistics/event-types'},
